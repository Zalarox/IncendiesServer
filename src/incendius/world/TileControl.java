...
public class TileControl {
	...
	public static Tile[] getTiles(Player client) {
	...
	public static int calculateDistance(Player client, Player following) {
	...
	public static int calculateDistance(NPC npc, Player following) {
	...
	public static int calculateDistance(Player client, NPC npc) {
	...
	public static int[] currentLocation(Player client) {
