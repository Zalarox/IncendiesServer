...
public class ObjectManager {
	...
	public void loadCustomSpawns(Player c) {
		...
		if (c.party != null && c.party.floor != null) {
			for (int i = 0; i < incendius.game.players.content.skills.dungeoneering.Constants.OBJECT[c.party.floor.roomId].length; i++) {
				c.getPA().checkObjectSpawn(
						incendius.game.players.content.skills.dungeoneering.Constants.OBJECT[c.party.floor.roomId][i][0],
						incendius.game.players.content.skills.dungeoneering.Constants.OBJECT[c.party.floor.roomId][i][1],
						incendius.game.players.content.skills.dungeoneering.Constants.OBJECT[c.party.floor.roomId][i][2],
						incendius.game.players.content.skills.dungeoneering.Constants.OBJECT[c.party.floor.roomId][i][3],
						incendius.game.players.content.skills.dungeoneering.Constants.OBJECT[c.party.floor.roomId][i][4]);
			}
		}
	}
