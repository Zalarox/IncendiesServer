...
import incendius.game.players.content.Enchanting;
...
public class PlayerAssistant {
	...
	public void applyDead() {
		...
		c.faceUpdate(0);
		Server.getScheduler().schedule(new Task(5) {
	...
	public void addStarter() {
		...
		Server.pJClans.saveClan(c.playerName, c.playerName, 0);
		Server.clanChat.loadClan(c.playerName, c.playerName, 0);
	}
