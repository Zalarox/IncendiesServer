...
public class QuickPrayers {
	...
	private static final int[][] data = { { 67050, 630, 0 }, { 67051, 631, 1 }, { 67052, 632, 2 }, { 67053, 633, 3 },
			...
			{ 67069, 649, 19 }, { 67070, 650, 20 }, { 67071, 651, 21 }, { 67072, 652, 22 }, { 67073, 653, 23 },
			{ 67074, 654, 24 }, { 67075, 655, 25 } };// actionID, frameID,
														// quickCurse = true

	public static void clickPray(Player c, int actionId) {
