...
public class SkillInterfaces {
	...
	private void menuLine(final String levels, final String lines, final int ids, final int lineCounter) {
		...
		c.getPA().sendString(levels, 8720 + lineCounter);
	...
	public void attackComplex(int screen) {
		if (screen == 1) {
			...
			String level = "70";
			String type = "Barrows";
			menuLine(level, "Ahrim's Staff\\n(with 70 Magic)", 4710, 0);
			menuLine(level, "Dharok's Greataxe\\n(with 70 Strength)", 4718, 1);
			menuLine(level, "Guthan's Spear", 4726, 2);
			menuLine(level, "Torag's Hammers\\n(with 70 Strength)", 4747, 3);
			menuLine(level, "Verac's Flail", 4755, 4);
			optionTab("Attack", type, "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune",
					"Dragon", "Barrows", "Special", "Milestones", "");
		} else if (screen == 11) {
			clearMenu();
			menuLine("50", "Leaf-Bladed Spear\\n(with 55 Slayer)", 4158, 0);
			menuLine("50", "Ancient Staff\\n(with 50 Magic)", 4675, 1);
			...
			menuLine("70", "Saradomin Sword", 11730, 8);
			menuLine("75", "Armadyl Godsword", 11694, 9);
			menuLine("75", "Bando Godsword", 11696, 10);
			menuLine("75", "Saradomin Godsword", 11698, 11);
			menuLine("78", "Vesta's Longsword", 13899, 12);
			menuLine("78", "Statius's Warhammer", 13902, 13);
			menuLine("80", "Chaotic Weapons\\n(with 80 Dungeoneering)", 18353, 14);
	...
	public void strengthComplex(int screen) {
		if (screen == 1) {
			clearMenu();
			menuLine("5", "Black Halberd\\n(with 10 Attack)", 3196, 0);
			menuLine("5", "White Halberd\\n(with 10 Attack)", 6599, 1);
			menuLine("10", "Mithril Halberd\\n(with 20 Attack)", 3198, 2);
			menuLine("15", "Adamant Halberd\\n(with 30 Attack)", 3200, 3);
			menuLine("20", "Rune Halberd\\n(with 40 Attack)", 3202, 4);
			menuLine("30", "Dragon Halberd\\n(with 60 Attack)", 3204, 5);
			menuLine("50", "Granite Maul\\n(with 50 Attack)", 4153, 6);
			menuLine("60", "TzHaar-Ket-Om", 6528, 7);
			menuLine("70", "Dharok's Greataxe\\n(with 70 Attack)", 4718, 8);
			menuLine("70", "Torag's Hammers\\n(with 70 Attack)", 4747, 9);
			...
			clearMenu();
			menuLine("50", "Granite Shield\\n(with 50 Defence)", 3122, 0);
	...
	public void defenceComplex(int screen) {
		if (screen == 1) {
			...
			menuLine(level, type + " Platebody", 14479, 3);
			menuLine(level, type + " Plateskirt", 4585, 5);
			menuLine(level, type + " Platelegs", 4087, 6);
			optionTab("Defence", type, "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune",
					"Dragon", "Barrows", "Magic", "Equipment", "Milestones");
		}
			...
			clearMenu();
			String level = "70";
			menuLine(level, "Ahrim's Hood\\n(with 70 Magic)", 4708, 0);
			menuLine(level, "Ahrim's Robe Top\\n(with 70 Magic)", 4712, 1);
			menuLine(level, "Ahrim's robeskirt\\n(with 70 Magic)", 4714, 2);
			...
			menuLine(level, "Karil's Coif\\n(with 70 Ranged)", 4732, 9);
			menuLine(level, "Karil's Leather Top\\n(with 70 Ranged)", 4736, 10);
			menuLine(level, "Karil's Leather Skirt\\n(with 70 Ranged)", 4738, 11);
			...
			menuLine("20", "Enchanted Hat\\n(with 40 Magic)", 7400, 3);
			menuLine("20", "Enchanted Robe Top\\n(with 40 Magic)", 7399, 4);
			menuLine("20", "Enchanted Robe\\n(with 40 Magic)", 7398, 5);
			menuLine("20", "Mystic Hat\\n(with 40 Magic)", 4099, 6);
			menuLine("20", "Mystic Robe Top\\n(with 40 Magic)", 4101, 7);
			menuLine("20", "Mystic Robe\\n(with 40 Magic)", 4103, 8);
			menuLine("20", "Mystic Gloves\\n(with 40 Magic)", 4105, 9);
			menuLine("20", "Mystic Boots\\n(with 40 Magic)", 4107, 10);
			menuLine("25", "Infinity Hat\\n(with 50 Magic)", 6918, 11);
			menuLine("25", "Infinity Ttop\\n(with 50 Magic)", 6916, 12);
			menuLine("25", "Infinity Bottom\\n(with 50 Magic)", 6924, 13);
			menuLine("25", "Infinity Gloves\\n(with 50 Magic)", 6922, 14);
			menuLine("25", "Infinity Boots\\n(with 50 Magic)", 6920, 15);
			menuLine("40", "Splitbark Helm\\n(with 40 Magic)", 3385, 16);
			menuLine("40", "Splitbark Body\\n(with 40 Magic)", 3387, 17);
			menuLine("40", "Splitbark Legs\\n(with 40 Magic)", 3389, 18);
			menuLine("40", "Splitbark Gauntlets\\n(with 40 Magic)", 3391, 19);
			menuLine("40", "Splitbark Boots\\n(with 40 Magic)", 3393, 20);
			menuLine("40", "Skeletal Helm\\n(with 40 Magic)", 6137, 21);
			menuLine("40", "Skeletal Top\\n(with 40 Magic)", 6139, 22);
			menuLine("40", "Skeletal Bottoms\\n(with 40 Magic)", 6141, 23);
			...
			menuLine("20", "Studded Body\\n(with 20 Ranged)", 1133, 9);
			menuLine("20", "Initiate Helm\\n(with 10 Prayer)", 5574, 10);
			menuLine("20", "Initiate Platemail\\n(with 10 Prayer)", 5575, 11);
			menuLine("20", "Initiate Platelegs\\n(with 10 Prayer)", 5576, 12);
			menuLine("20", "Mirror Shield(with 20 Slayer)", 4156, 13);
			menuLine("30", "Snakeskin armour\\n(with 30 Ranged)", 6322, 14);
			menuLine("40", "Green Dragonhide Body\\n(with 40 Ranged)", 1135, 15);
			menuLine("40", "Blue Dragonhide Body\\n(with 40 Ranged)", 2499, 16);
			menuLine("40", "Red Dragonhide Body\\n(with 40 Ranged)", 2501, 17);
			menuLine("40", "Black Dragonhide Body\\n(with 40 Ranged)", 2503, 18);
			menuLine("40", "Spined Armour\\n(with 40 Ranged)", 6133, 19);
			...
			menuLine("50", "Granite Shield\\n(with 50 Strength)", 3122, 25);
			menuLine("60", "TokTz-Ket-Xil", 6524, 26);
			menuLine("65", "Bandos armour", 11724, 27);
			menuLine("70", "Crystal Shield\\n(with 50 Agility)", 4224, 28);
			menuLine("70", "Armadyl armour\\n(with 70 Range)", 11720, 29);
			menuLine("75", "Dragonfire Shield", 11283, 30);
			optionTab("Defence", "Equipment", "Bronze", "Iron", "Steel", "Black", "White", "Mithril", "Adamant", "Rune",
					"Dragon", "Barrows", "Magic", "Equipment", "Milestones");
		}
	...
	public void rangedComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("70", "Crystal Bow\\n(with 50 Agility)", 4212, 9);
			...
			menuLine("1", "Hardleather Body\\n(with 10 Defence)", 1131, 1);
			menuLine("1", "Spined Boots", 6143, 2);
			menuLine("1", "Spined Gloves", 6149, 3);
			menuLine("1", "Archer Helm\\n(with 45 Defence)", 3749, 4);
			menuLine("20", "Studded Leather Body\\n(with 20 Defence)", 1133, 5);
			menuLine("20", "Studded Leather Chaps", 1097, 6);
			menuLine("20", "Coif", 1169, 7);
			menuLine("30", "Snakeskin Body\\n(with 30 Defence)", 6322, 8);
			menuLine("30", "Snakeskin Chaps\\n(with 30 Defence)", 6324, 9);
			menuLine("30", "Snakeskin Vambraces\\n(with 30 Defence)", 6330, 10);
			menuLine("30", "Snakeskin Bandana\\n(with 30 Defence)", 6326, 11);
			menuLine("30", "Snakeskin Boots\\n(with 30 Defence)", 6328, 12);
			...
			menuLine("40", "Green Dragonhide Body\\n(with 40 Defence)", 1135, 17);
			menuLine("40", "Spined Body\\n(with 40 Defence)", 6133, 18);
			menuLine("40", "Spined Chaps\\n(with 40 Defence)", 6135, 19);
			menuLine("40", "Spined Helm\\n(with 40 Defence)", 6131, 20);
			menuLine("50", "Blue Dragonhide Vambraces", 2487, 21);
			menuLine("50", "Blue Dragonhide Chaps", 2493, 22);
			menuLine("50", "Blue Dragonhide Body\\n(with 40 Defence)", 2499, 23);
			menuLine("60", "Red Dragonhide Vambraces", 2489, 24);
			menuLine("60", "Red Dragonhide Chaps", 2495, 25);
			menuLine("60", "Red Dragonhide Body\\n(with 40 Defence)", 2501, 26);
			menuLine("70", "Black Dragonhdie Vambraces", 2491, 27);
			menuLine("70", "Black Dragonhdie Chaps", 2497, 28);
			menuLine("70", "Black Dragonhdie Body\\n(with 40 Defence)", 2503, 29);
			menuLine("70", "Karil's Coif\\n(with 70 Defence)", 4732, 30);
			menuLine("70", "Karil's Leathertop\\n(with 70 Defence)", 4736, 31);
			menuLine("70", "Karil's Leatherskirt\\n(with 70 Defence)", 4738, 32);
			...
			clearMenu();
			menuLine("60", "Dark Bow", 11235, 0);
			menuLine("61", "Rune crossbow", 9185, 1);
			menuLine("70", "Karil's crossbow", 4734, 2);
			menuLine("80", "Chaotic crossbow\\n(with 80 Dungeoneering)", 18357, 3);
			...
			clearMenu();
			menuLine("50", "Broad-tipped arrows\\n(with 55 Slayer)", 4150, 0);
			menuLine("50", "Broad-tipped bolts\\n(with 55 Slayer)", 13280, 1);
	...
	public void prayerComplex(int screen) {
		if (screen == 1) {
			clearMenu();
			// menuLine("", "You can see what each of these prayers\\ndoes by
			// selecting the Prayer icon on\\nyour side interface. Move your
			// mouse\\nover the icon of the prayer you want\\nand a description
			// will be available", 0, 0);
			menuLine("1", "Thick Skin", 1714, 0);
			menuLine("4", "Burst of Strength", 1714, 1);
			menuLine("7", "Clarity of Thought", 1714, 2);
			menuLine("10", "Rock Skin", 1714, 3);
			menuLine("13", "Superhuman Strength", 1714, 4);
			menuLine("16", "Improved Reflexes", 1714, 5);
			menuLine("19", "Rapid Restore", 1714, 6);
			menuLine("22", "Rapid Heal", 1714, 7);
			menuLine("25", "Protect Item", 1714, 8);
			menuLine("28", "Steel Skin", 1714, 9);
			menuLine("31", "Ultimate Strength", 1714, 10);
			menuLine("34", "Incredible Reflexes", 1714, 11);
			menuLine("37", "Protect from Magic", 1714, 12);
			menuLine("40", "Protect from Missles", 1714, 13);
			menuLine("43", "Protect from Melee", 1714, 14);
			menuLine("46", "Retribution", 1714, 15);
			menuLine("49", "Redemption", 1714, 16);
			menuLine("50", "Protect Item\\n(after Zurok's Legend)", 1714, 17);
			menuLine("50", "Sap Warrior\\n(after Zurok's Legend)", 1714, 18);
			menuLine("52", "Smite", 1714, 19);
			menuLine("52", "Sap Ranger\\n(after Zurok's Legend)", 1714, 20);
			menuLine("54", "Sap Mage\\n(after Zurok's Legend)", 1714, 21);
			menuLine("56", "Sap Spirit\\n(after Zurok's Legend)", 1714, 22);
			menuLine("59", "Berserker\\n(after Zurok's Legend)", 1714, 23);
			menuLine("62", "Deflect Summoning\\n(after Zurok's Legend)", 1714, 24);
			menuLine("65", "Deflect Magic\\n(after Zurok's Legend)", 1714, 25);
			menuLine("68", "Deflect Missiles\\n(after Zurok's Legend)", 1714, 26);
			menuLine("71", "Deflect Melee\\n(after Zurok's Legend)", 1714, 27);
			menuLine("74", "Leech Attack\\n(after Zurok's Legend)", 1714, 28);
			menuLine("76", "Leech Ranged\\n(after Zurok's Legend)", 1714, 29);
			menuLine("78", "Leech Magic\\n(after Zurok's Legend)", 1714, 30);
			menuLine("80", "Leech Defence\\n(after Zurok's Legend)", 1714, 31);
			menuLine("82", "Leech Strength\\n(after Zurok's Legend)", 1714, 32);
			menuLine("84", "Leech Energy\\n(after Zurok's Legend)", 1714, 33);
			menuLine("86", "Leech Special Attack\\n(after Zurok's Legend)", 1714, 34);
			menuLine("89", "Wrath\\n(after Zurok's Legend)", 1714, 35);
			menuLine("92", "Soul Split\\n(after Zurok's Legend)", 1714, 36);
			menuLine("95", "Turmoil\\n(after Zurok's Legend)", 1714, 37);
			...
			clearMenu();
			menuLine("10", "Initiate Helm\\n(with 20 Defence)", 5574, 0);
			menuLine("10", "Initiate Platemail\\n(with 20 Defence)", 5575, 1);
			menuLine("10", "Initiate Platelegs\\n(with 20 Defence)", 5576, 2);
	...
	public void magicComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("1", "Farseer Helm\\n(with 45 Defence)", 3755, 0);
			...
			menuLine("40", "Mystic Hat\\n(with 20 Defence)", 4099, 5);
			menuLine("40", "Mystic Robe Top\\n(with 20 Defence)", 4101, 6);
			menuLine("40", "Mystic Robe Bottom\\n(with 20 Defence)", 4103, 7);
			menuLine("40", "Mystic Gloves\\n(with 20 Defence)", 4105, 8);
			menuLine("40", "Mystic Boots\\n(with 20 Defence)", 4107, 9);
			menuLine("40", "Enchanted Hat\\n(with 20 Defence)", 7400, 10);
			menuLine("40", "Enchanted Top\\n(with 20 Defence)", 7399, 11);
			menuLine("40", "Enchanted Robe\\n(with 20 Defence)", 7398, 12);
			menuLine("40", "Splitbark Helm\\n(with 40 Defence)", 3385, 13);
			menuLine("40", "Splitbark Body\\n(with 40 Defence)", 3387, 14);
			menuLine("40", "Splitbark Legs\\n(with 40 Defence)", 3389, 15);
			menuLine("40", "Splitbark Gauntlets\\n(with 40 Defence)", 3391, 16);
			menuLine("40", "Splitbark Boots\\n(with 40 Defence)", 3393, 17);
			menuLine("40", "Skeletal Helmet\\n(with 40 Defence)", 6137, 18);
			menuLine("40", "Skeletal Top\\n(with 40 Defence)", 6139, 19);
			menuLine("40", "Skeletal Bottoms\\n(with 40 Defence)", 6141, 20);
			menuLine("50", "Infinity Hat\\n(with 25 Defence)", 6918, 21);
			menuLine("50", "Infinity Top\\n(with 25 Defence)", 6916, 22);
			menuLine("50", "Infinity Bottom\\n(with 25 Defence)", 6924, 23);
			menuLine("50", "Infinity Boots\\n(with 25 Defence)", 6920, 24);
			menuLine("50", "Infinity Gloves(with 25 Defence)", 6922, 25);
			menuLine("70", "Ahrim's Hood\\n(with 70 Defence)", 4708, 26);
			menuLine("70", "Ahrim's Robe Top\\n(with 70 Defence)", 4712, 27);
			menuLine("70", "Ahrim's Robeskirt\\n(with 70 Defence)", 4714, 28);
			...
			menuLine("30", "Air Battlestaff\\n(with 30 Attack)", 1397, 6);
			menuLine("30", "Earth Battlestaff\\n(with 30 Attack)", 1399, 7);
			menuLine("30", "Fire Battlestaff\\n(with 30 Attack)", 1393, 8);
			menuLine("30", "Water Battlestaff\\n(with 30 Attack)", 1395, 9);
			menuLine("30", "Lava Battlestaff\\n(with 30 Attack)", 3053, 10);
			menuLine("30", "Mud Battlestaff\\n(with 30 Attack)", 6562, 11);
			menuLine("40", "Mystic Air Staff\\n(with 40 Attack)", 1405, 12);
			menuLine("40", "Mystic Earth Staff\\n(with 40 Attack)", 1407, 13);
			menuLine("40", "Mystic Fire Staff\\n(with 40 Attack)", 1401, 14);
			menuLine("40", "Mystic Water Staff\\n(with 40 Attack)", 1403, 15);
			menuLine("40", "Mystic Lava Staff\\n(with 40 Attack)", 3054, 16);
			menuLine("40", "Mystic Mud Staff\\n(with 40 Attack)", 6563, 17);
			menuLine("50", "Slayer's Staff\\n(with 55 Slayer)", 4170, 18);
			menuLine("50", "Iban's Staff\\n(with 50 Attack)", 1409, 19);
			menuLine("50", "Ancient Staff\\n(with 50 Attack)", 4675, 20);
			...
			menuLine("70", "Ahrim's Staff\\n(with 70 Attack)", 4710, 25);
			menuLine("80", "Chaotic Staff\\n(with 80 Dungeoneering)", 18355, 26);
	...
	public void runecraftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("40", "Astral runes", 9075, 14);
			menuLine("44", "Nature runes", 561, 15);
			menuLine("54", "Law runes", 563, 16);
			menuLine("65", "Death runes", 560, 17);
			menuLine("77", "Blood runes", 565, 18);
			...
			menuLine("82", "2 Astral runes per essence", 9075, 24);
			menuLine("84", "7 Mind runes per essence", 558, 25);
			menuLine("88", "9 Air runes per essence", 556, 26);
			menuLine("91", "2 Nature runes per essence", 561, 27);
			menuLine("92", "3 Body runes per essence", 559, 28);
			menuLine("95", "6 Water runes per essence", 555, 29);
	...
	public void hitpointsComplex(int screen) {
		if (screen == 1) {
			clearMenu();
			menuLine("", "Hitpoints tell you how healthy your", 0, 0);
			...
			menuLine("", "", 0, 4);
			menuLine("", "If you see any red 'hitsplats' during", 0, 5);
			...
			menuLine("", "", 0, 9);
			menuLine("", "Blue hitsplats mean no damage has", 0, 10);
			menuLine("", "been dealt.", 0, 11);
			menuLine("", "", 0, 12);
			menuLine("", "Green hitsplats are poison damage.", 0, 13);
			menuLine("", "", 0, 14);
			menuLine("", "Yellow hitsplats are disease damage.", 0, 15);
	...
	public void agilityComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("50", "Rogues' Den\\n(with 50 Thieving)", 6518, 9);
	...
	public void herbloreComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("88", "Extreme Attack", 15309, 25);
			menuLine("89", "Extreme Strength", 15313, 26);
			menuLine("90", "Extreme Defence", 15317, 27);
			menuLine("91", "Extreme Magic", 15321, 28);
			menuLine("92", "Extreme Ranging", 15325, 29);
			menuLine("96", "Overload", 15333, 30);
	...
	public void slayerComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("25", "Mirror Shield\\n(with 20 Defence)", 4156, 7);
			...
			menuLine("55", "Broad-tipped arrows\\n(with 50 Ranging)", 4150, 13);
			menuLine("55", "Broad-tipped bolts\\n(with 50 Ranging)", 13280, 14);
			menuLine("55", "Slayer's Staff\\n(with 50 Magic)", 4170, 15);
			menuLine("57", "Fungicide Spray", 7421, 16);
			menuLine("60", "Nose Peg", 4168, 17);
	...
	public void miningComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("20", "Silver Ore", 442, 7);
			menuLine("30", "Coal", 453, 8);
			menuLine("30", "Pure Essence", 7936, 9);
			menuLine("40", "Gold Ore", 444, 10);
			menuLine("40", "Gem Rocks", 1603, 11);
			menuLine("55", "Mithril Ore", 447, 12);
			menuLine("70", "Adamantite Ore", 449, 13);
			menuLine("85", "Runite Ore", 451, 14);
			...
			menuLine("61", "Dragon Pickaxe", 15259, 6);
	...
	public void smithingComplex(int screen) {
		if (screen == 1) {
			...
			optionTab("Smithing", "Elemental", "Smelting", "Bronze", "Iron", "Steel", "Mithril", "Adamantite", "Runite",
					"Gold", "Elemental", "Other", "Milestones", "", "");
		} else if (screen == 10) {
			clearMenu();
	...
	public void fishingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("90", "Rocktail - Bait fishing", 15272, 25);
	...
	public void cookingComplex(int screen) {
		if (screen == 1) {
			...
			optionTab("Cooking", "Potatoes", "Meats", "Bread", "Pies", "Stews", "Pizzas", "Cakes", "Wine", "Hot Drinks",
					"Brewing", "Potatoes", "Diary", "Gnome", "Milestones");
		}
	...
	public void forageComplex(int screen) {
		if (screen == 1) {
			clearMenu();
			menuLine("1", "Bedabin Tribe", 4625, 0);
			menuLine("5", "Mountain Tribe", 4502, 1);
			menuLine("10", "Dorgeshuun Tribe", 8880, 2);
			menuLine("20", "Fremennik Tribe", 3686, 3);
			menuLine("30", "Rantuki Tribe", 1857, 4);
			menuLine("35", "Ogre Tribe", 12570, 5);
			menuLine("50", "Troll Tribe", 8136, 6);
			menuLine("65", "Moonclan Tribe", 9068, 7);
			menuLine("75", "TzHaar Tribe", 6528, 8);
			menuLine("85", "Rantuki Tribe (Experienced)\\n(with 70 combat)", 750, 9);
			optionTab("Foraging", "Tribes", "Masters", "Spots", "Rewards", "Milestones", "", "", "", "", "", "", "", "",
					"");
		} else if (screen == 2) {
			clearMenu();
			menuLine("5", "Desert forage spot", 6289, 0);
			menuLine("10", "Bear Cave forage spot", 948, 1);
			menuLine("25", "Dorgeshuun forage spot", 8880, 2);
			menuLine("40", "Relekka forage spot", 3686, 3);
			menuLine("55", "Brimhaven forage spot", 2997, 4);
			menuLine("70", "Suqah forage spot", 9068, 5);
			menuLine("85", "TzHaar forage spot", 6528, 6);
			menuLine("99", "Wilderness forage spot", 536, 7);
			optionTab("Foraging", "Tribes", "Masters", "Spots", "Rewards", "Milestones", "", "", "", "", "", "", "", "",
					"");
		} else if (screen == 3) {
			clearMenu();
			menuLine("20", "Bear armour technique", 14347, 0);
			menuLine("50", "Bear armour upgrade", 14351, 1);
			optionTab("Foraging", "Tribes", "Masters", "Spots", "Rewards", "Milestones", "", "", "", "", "", "", "", "",
					"");
		} else if (screen == 4) {
			clearMenu();
			menuLine("50", "Forage twice a day", 0, 0);
			menuLine("75", "Forage triple a day", 0, 1);
			menuLine("99", "Skill Mastery", 0, 2);
			optionTab("Foraging", "Tribes", "Masters", "Spots", "Rewards", "Milestones", "", "", "", "", "", "", "", "",
					"");
		}
	}
	...
	public void buttons(int b) {
		...
		case 106075: // agility
			...
			selected = 8;
			break;
		case 106078: // herblore
			herbloreComplex(1);
			selected = 9;
			break;
		case 106081: // theiving
			thievingComplex(1);
			selected = 10;
			break;
		case 106084: // crafting
			craftingComplex(1);
			selected = 11;
			break;
		case 106087: // fletching
			fletchingComplex(1);
			selected = 12;
			break;
		case 106090:// slayer
