...
public class PestControl {
	...
	public void pestSpawns() {
		...
		for (int i = 0; i < pest.length; i++) {
			Server.npcHandler.spawnNpc(pest[Misc.random(3)], coords[i][0], coords[i][1], 0, 0, 75, 8, 60,
					50 + Misc.random(25));
		}
		Server.npcHandler.spawnNpc(3741, 2655 + Misc.random(2), 2592 + Misc.random(2), 0, 0, 70, 4, 100, 50);
		Server.npcHandler.spawnNpc(3741, 2657 - Misc.random(2), 2592 - Misc.random(2), 0, 0, 70, 4, 100, 50);
		Server.npcHandler.spawnNpc(3741, 2657 - Misc.random(2), 2593 + Misc.random(2), 0, 0, 70, 4, 100, 50);
	}

	private void spawnNpcs() {
		for (int i = 0; i < pcNPCData.length; i++) {
			Server.npcHandler.newNPC(pcNPCData[i][0], pcNPCData[i][1], pcNPCData[i][2], 0, 0, 2000, 0, 0, 100, 0);
