package incendius.game.players.content.skills.fletching;
...
public class BowHandler {
	...
	private static enum Bow {
		...
		SHORTBOW(1511, 34205, 34204, 34203, 34202, 50, 5, 1), OAK_SHORTBOW(1521, 34185, 34184, 34183, 34182, 54, 17,
				20), WILLOW_SHORTBOW(1519, 34185, 34184, 34183, 34182, 60, 33, 35), MAPLE_SHORTBOW(1517, 34185, 34184,
						34183, 34182, 64, 50, 50), YEW_SHORTBOW(1515, 34185, 34184, 34183, 34182, 68, 68,
								65), MAGIC_SHORTBOW(1513, 34170, 34169, 34168, 34167, 72, 83, 80);

		private int log, button, button5, button10, buttonAll, item, XP, req;

		private Bow(final int log, final int button, final int button5, final int button10, final int buttonAll,
				final int item, final int XP, final int req) {
			this.log = log;
			this.button = button;
	...
	private static enum Crossbow {
		...
		CROSSBOW(1511, 34213, 34212, 34211, 34210, 9440, 6, 9), OAK_CROSSBOW(1521, 34193, 34192, 34191, 34190, 9442, 22,
				39), WILLOW_CROSSBOW(1519, 34193, 34192, 34191, 34190, 9444, 27, 46), MAPLE_CROSSBOW(1517, 34193, 34192,
						34191, 34190, 9448, 41, 54), YEW_CROSSBOW(1515, 34193, 34192, 34191, 34190, 9452, 50, 69);

		private int log, button, button5, button10, buttonAll, item, XP, req;

		private Crossbow(final int log, final int button, final int button5, final int button10, final int buttonAll,
				final int item, final int XP, final int req) {
			this.log = log;
			this.button = button;
			this.button5 = button5;
	...
	private static enum Longbow {
		...
		LONGBOW(1511, 34209, 34208, 34207, 34206, 48, 10, 10), OAK_LONGBOW(1521, 34189, 34188, 34187, 34186, 56, 25,
				25), WILLOW_LONGBOW(1519, 34189, 34188, 34187, 34186, 58, 42, 40), MAPLE_LONGBOW(1517, 34189, 34188,
						34187, 34186, 62, 58, 55), YEW_LONGBOW(1515, 34189, 34188, 34187, 34186, 66, 75,
								70), MAGIC_LONGBOW(1513, 34174, 34173, 34172, 34171, 70, 92, 85);

		private int log, button, button5, button10, buttonAll, item, XP, req;

		private Longbow(final int log, final int button, final int button5, final int button10, final int buttonAll,
				final int item, final int XP, final int req) {
			this.log = log;
			this.button = button;
			this.button5 = button5;
	...
	public static void handleFletchingButtons(final Player c, final int button) {
		...
		if (button <= 34185 && button >= 34181 || button <= 34170 && button >= 34167
				|| button >= 34202 && button <= 34205) {
			fletchUnstrungBow(c, button);
			return;
		}
		if (button <= 34189 && button >= 34186 || button <= 34174 && button >= 34171
				|| button >= 34206 && button <= 34209) {
			fletchUnstrungLongbow(c, button);
			return;
		}
		if (button <= 34213 && button >= 34210 || button <= 34193 && button >= 34190) {
