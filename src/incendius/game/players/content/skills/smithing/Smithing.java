...
public class Smithing {
	...
	private void CheckAddy(final Player c, final int level, final int amounttomake, final String type) {
		remove = 2361;
	...
	private void CheckBronze(final Player c, final int level, final int amounttomake, final String type) {
	...
	private void CheckIron(final Player c, final int level, final int amounttomake, final String type) {
		remove = 2351;
	...
	private void CheckMith(final Player c, final int level, final int amounttomake, final String type) {
		remove = 2359;
	...
	private void CheckRune(final Player c, final int level, final int amounttomake, final String type) {
		remove = 2363;
	...
	private void CheckSteel(final Player c, final int level, final int amounttomake, final String type) {
		remove = 2353;
	...
	public void readInput(final int level, final String type, final Player c, final int amounttomake) {
