package incendius.game.players.content.skills.dungeoneering.skills;

import incendius.game.players.Player;
import incendius.handlers.SkillHandler;

/**
 * @author Ochroid | Scott & Thelife/Alex
 */
public class Herblore {

	private static final int[][] CLEANING_HERB = { { 17494, 17512, 3, 100 }, { 17496, 17514, 4, 110 },
			{ 17498, 17516, 8, 120 }, { 17500, 17518, 34, 150 }, { 17502, 17520, 37, 200 }, { 17504, 17522, 41, 300 },
			{ 17506, 17524, 67, 400 }, { 17508, 17526, 71, 450 }, { 17510, 17528, 74, 600 } };

	// TODO Vials and Potions creating
		...
		for (int i = 0; i < ITEM_ON_VIAL.length; i++) {
			if ((useItem == 227 && otherItem == ITEM_ON_VIAL[i][0])
				...
				if (c.getInstance().playerLevel[c.playerHerblore] < ITEM_ON_VIAL[i][2]) {
					...
					incendius.game.players.content.skills.herblore.Herblore.resetHerblore(c);
					return;
				}
	...
	public static void clean(Player c, int itemId) {
		if (c.party == null)
			return;
		if (c.party.floor == null)
			return;
