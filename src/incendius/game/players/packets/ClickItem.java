...
import incendius.game.players.content.ArmourSets;
...
public class ClickItem implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		incendius.game.players.content.skills.dungeoneering.skills.Herblore.clean(c, itemId);
		switch (frame) {
		...
		case 15088:
			...
			break;
		case 15707:
			incendius.game.players.content.skills.dungeoneering.Items.teleport(c, true);
			break;
		case 19650:
			incendius.game.players.content.skills.dungeoneering.Items.handleToolKit(c);
			break;
		}
	}
