...
public class Region {
	...
	public ArrayList<main.game.objects.Object> realObjects = new ArrayList<main.game.objects.Object>();
	...
	public static boolean objectExists(int id, int x, int y, int z) {
		...
		if (r == null)
			return false;
		for (main.game.objects.Object o : r.realObjects) {
			if (o.objectId == id) {
	...
	public static void addObject(int objectId, int x, int y, int height, int type, int direction) {
		...
		r.realObjects.add(new main.game.objects.Object(objectId, x, y, height, direction, type));
		if (objectId < 0)
			return;
