		...
		CycleEventHandler.getSingleton().addEvent(new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				if (SkillHandler.skillCheck(player.getVariables().playerLevel[Constants.MINING], r.levelReq,
					...
					GameEngine.objectHandler.placeObject(new Objects(emptyOre(objectId), obX, obY, player.heightLevel,
					...
					CycleEventHandler.getInstance().addEvent(new CycleEvent() {
						...
						@Override
						public void stop() {
							GameEngine.objectHandler.placeObject(new Objects(objectId, obX, obY, player.heightLevel,
									obj != null ? obj.objectFace : 0, 10));
						}
