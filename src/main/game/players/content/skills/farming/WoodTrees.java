 ...
 */
package main.game.players.content.skills.farming;
...
import main.game.players.content.skills.farming.ChopTree.Tree;
...
public class WoodTrees {
	...
	public void doCalculations() {
		for (int i = 0; i < treeSaplings.length; i++) {
			if (treeStages[i] > 0 && treeStages[i] <= 3 && GameEngine.getMinutesCounter() - treeTimer[i] >= 5) {
				treeStages[i]--;
	...
	public boolean clearPatch(int objectX, int objectY, int itemId) {
		...
		CycleEventHandler.getInstance().addEvent(player, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				treeTimer[hopsFieldsData.getTreeIndex()] = GameEngine.getMinutesCounter();
				updateTreeStates();
				if (treeStages[hopsFieldsData.getTreeIndex()] == 3) {
					container.stop();
					return;
	...
	public boolean plantSapling(int objectX, int objectY, final int saplingId) {
		...
		CycleEventHandler.getInstance().addEvent(player, new CycleEvent() {
			...
			public void execute(CycleEventContainer container) {
				...
				treeTimer[treeFieldsData.getTreeIndex()] = GameEngine.getMinutesCounter();
