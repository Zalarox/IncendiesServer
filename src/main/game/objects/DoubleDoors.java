...
public class DoubleDoors {
	...
	public void changeLeftDoor(DoubleDoors d) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) {
			GameEngine.objectHandler.placeObject(new Objects(-1, d.x, d.y, d.z, 0, 0, 0, false));
		}
		...
		GameEngine.objectHandler.placeObject(new Objects(d.doorId, d.x, d.y, d.z, getNextLeftFace(d), 0, 0, false));
	}
	...
	public void changeRightDoor(DoubleDoors d) {
		...
		GameEngine.objectHandler.placeObject(new Objects(d.doorId, d.x, d.y, d.z, getNextRightFace(d), 0, 0, false));
	}
