...
public class Menus {
	...
	public static void sendSkillMenu(Player player, String type) {
		...
		if (type == "potteryUnfired") {
			...
			player.getPA().showInterface(11462);
		} else if (type == "normalLeather") {
			player.getPA().showInterface(2311);
		...
		/* Cooking */
			...
			player.getPA().sendChatInterface(15336);
		}
	...
	public static void display5Item(Player player, int i1, int i2, int i3, int i4, int i5, String s1, String s2,
			String s3, String s4, String s5) {

		player.getPA().sendFrame246(8941, 120, i1);
		player.getPA().sendFrame246(8942, 150, i2);
		player.getPA().sendFrame246(8943, 150, i3);
		player.getPA().sendFrame246(8944, 120, i4);
		player.getPA().sendFrame246(8945, 150, i5);
		player.getPA().sendString(s1, 8949);
		player.getPA().sendString(s2, 8953);
		player.getPA().sendString(s3, 8957);
		player.getPA().sendString(s4, 8961);
		player.getPA().sendString(s5, 8965);
		player.getPA().sendChatInterface(8938);
	}

	public static void display4Item(Player player, int i1, int i2, int i3, int i4, String s1, String s2, String s3,
			String s4) {

		player.getPA().sendFrame246(8902, 250, i1);
		player.getPA().sendFrame246(8903, 150, i2);
		player.getPA().sendFrame246(8904, 200, i3);
		player.getPA().sendFrame246(8905, 250, i4);
		player.getPA().sendString(s1, 8909);
		player.getPA().sendString(s2, 8913);
		player.getPA().sendString(s3, 8917);
		player.getPA().sendString(s4, 8921);
		player.getPA().sendChatInterface(8899);
	}

	public static void display3Item(Player player, int i1, int i2, int i3, String s1, String s2, String s3) {

		player.getPA().sendString(s1, 8889);
		player.getPA().sendString(s2, 8893);
		player.getPA().sendString(s3, 8897);
	...
	public static void display3ItemSized(Player player, int i1, int i2, int i3, String s1, String s2, String s3) {
		...
		player.getPA().sendString(s2, 8893);
		player.getPA().sendString(s3, 8897);
		player.getPA().sendFrame246(8883, 150, i1);
		player.getPA().sendFrame246(8884, 100, i2);
		player.getPA().sendFrame246(8885, 100, i3);
		player.getPA().sendChatInterface(8880);
	}

	public static void display2Item(Player player, int i1, int i2, String s1, String s2) {

		player.getPA().sendString(s1, 8874);
		player.getPA().sendString(s2, 8878);
		player.getPA().sendFrame246(8869, 180, i1);
		player.getPA().sendFrame246(8870, 180, i2);
		player.getPA().sendChatInterface(8866);
	}

	public static void display1Item(Player player, int i1, String s1) {

		player.getPA().sendString(s1, 2799);
		player.getPA().sendFrame246(1746, 200, i1);
		player.getPA().sendChatInterface(4429);
	}
